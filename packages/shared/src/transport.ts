...
export const endpointContracts = {
  ...
  discoveryPreferencesRead: {
    method: "GET",
    path: "/api/discovery-preferences",
    request: null,
    response: discoveryPreferenceSchema,
  },
  discoveryPreferencesUpdate: {
    method: "PATCH",
    path: "/api/discovery-preferences",
    request: discoveryPreferenceSchema,
    response: discoveryPreferenceSchema,
  },
  meetupAcknowledgement: {
    method: "POST",
    path: "/api/meetups",
    request: meetupAcknowledgementRequestSchema,
    response: meetupAcknowledgementResponseSchema,
  },
  meetupAcknowledgementRead: {
    method: "GET",
    path: "/api/meetups?peerId=:peerId",
    request: null,
    response: meetupAcknowledgementReadResponseSchema,
  },
  friends: {
    method: "GET",
    path: "/api/friends",
