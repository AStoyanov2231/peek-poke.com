...
[Build an MCP server](https://developers.openai.com/apps-sdk/quickstart#build-an-mcp-server) and do not register a UI resource.
...
![Add your connector to ChatGPT](https://developers.openai.com/images/apps-sdk/new_connector.jpg)
