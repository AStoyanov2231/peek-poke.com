...
export function SplashScreen() {
  ...
  if (!bootstrap.isPending && !bootstrap.isError) {
    return null;
  }
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        {bootstrap.isError && (
          <div className="flex flex-col items-center gap-3 mt-2">
            <p className="t-caption text-center max-w-xs" style={{ color: "var(--danger-500)" }}>
              Failed to load your session. Please try again.
            </p>
            <Button onClick={() => bootstrap.refetch()} variant="secondary" className="rounded-pill">
